                ...
                {isFetching && (
                  <div className="absolute left-[-5px] top-[-5px]">
                    <span className="relative flex h-3 w-3">
                      <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-p2blue-500 opacity-75"></span>
                      <span className="relative inline-flex h-3 w-3 rounded-full bg-p2blue-700"></span>
                    </span>
                  </div>
                )}
              </div>
